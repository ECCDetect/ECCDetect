...
class roibatchLoader(data.Dataset):
  def __init__(self, roidb, ratio_list, ratio_index, batch_size, num_classes, training=False, normalize=None):
    self._roidb = roidb
  ...
  def __getitem__(self, index):
    ...
    if self.training:
        ...
        #print(ratio,"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
        #print(gt_boxes)
        #print(self._roidb[index_ratio]['need_crop'])
        #input()
