...
if __name__ == '__main__':
    ...
    if args.arch == 'rcnn':
        ...
        from lib.model.rfcn.resnet_atrous import resnet
    elif args.arch == 'couplenet':
        from lib.model.couplenet.resnet_atrous import resnet
    ...
    elif args.dataset == "imagenet_det":
        args.imdb_name = "imagenet_det_train"
        args.imdbval_name = "imagenet_val"
        args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '30']
    ...
    if args.use_det:
        ...
        det_imdb, det_roidb, det_ratio_list, det_ratio_index = combined_roidb(imdb_names[1])
    ...
    if args.net == 'vgg16':
        model = vgg16(imdb_classes, pretrained=True, pretrained_rfcn=True, class_agnostic=args.class_agnostic)
    elif args.net == 'res101':
        model = resnet(imdb_classes, 101, pretrained=True, pretrained_rfcn=True, class_agnostic=args.class_agnostic)
    elif args.net == 'res50':
        model = resnet(imdb_classes, 50, pretrained=True, pretrained_rfcn=True, class_agnostic=args.class_agnostic)
        #print(model)
        #input()
    elif args.net == 'res152':
        model = resnet(imdb_classes, 152, pretrained=True, pretrained_rfcn=True, class_agnostic=args.class_agnostic)
    else:
